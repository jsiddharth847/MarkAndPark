...
//       <div className="w-full max-w-md bg-gray-800/50 backdrop-blur-lg border border-gray-700 rounded-lg p-8">
//         <div className="space-y-2 mb-8">
//           <h1 className="text-3xl font-bold text-center bg-gradient-to-r from-yellow-500 to-yellow-300 bg-clip-text text-transparent">
//             Welcome Back
//           </h1>
...
//                 type="email"
//                 required
//                 className="w-full rounded-lg border border-gray-700 bg-gray-800/50 p-2 text-gray-100 placeholder-gray-500 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500/20"
...
//           {error && (
//             <div className="bg-red-900/20 border border-red-900 text-red-400 p-3 rounded-lg text-sm">
//               {error}
//             </div>
//           )}
...
//             type="submit"
//             disabled={loading}
//             className="w-full rounded-lg bg-gradient-to-r from-yellow-500 to-yellow-400 py-2.5 font-medium text-gray-900 hover:from-yellow-400 hover:to-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-500/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
//           >
